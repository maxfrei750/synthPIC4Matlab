function cleanTemImage = rendercleantemimage(vertices,faces,transmissionCoefficient)
%RENDERCLEANTEMIMAGE Renders a clean TEM image via raytracing.
%   Uses the GPU.
...
cleanTemImage = exp(-transmissionCoefficient*thicknessArray);
end
